...
<h1> No cars available :( </h1>
        ...
        <div class="w3-row w3-padding-32 w3-section">
            ...
            <div class="w3-col m8 w3-panel">
                <div class="w3-large w3-margin-bottom">
                    <i class="fa fa-map-marker fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> India<br>
                    <i class="fa fa-phone fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Phone: +91 8132044768<br>
                    <i class="fa fa-envelope fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Email: arpananand1903@gmail.com<br>
                </div>
                <p>New to city ? Drop Your Details and Leave it on us We'll Revert</p>
    ...
    <script
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBGT_iSj4mJ7o3JYm8oydjHwBCH0cl6Ns0&callback=myMap&libraries=&v=weekly"
      defer
    ></script>
